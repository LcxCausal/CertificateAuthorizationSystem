window.onload = function () {
    function goBarChart(dataArr){
        ...
        function drawMarkers(){
            ...
            ctx.fillText("数 量", -canvas.height/2, cSpace-10);
            ctx.restore();
            // 绘制标题 x
            ctx.fillText("月 份", originX+cWidth/2, originY+cSpace/2+10);
        };
        //绘制柱形图
    ...
    goBarChart(
        [[201905, 775], [201906, 750], [201907, 425], [201908, 960], [201909, 700], [201910, 800], [201911, 975], [201912, 375]]
    )
